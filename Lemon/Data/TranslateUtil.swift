...
let AppEnterbackground = false

class TranslateUtil: NSObject {
    static let shared = TranslateUtil()
...
extension TranslateUtil {
    ...
    private func requestSourceCode(text: String, completion: @escaping ((String)->Void)) {
    ...
    // 下载离线包
    private func requesTranslateModel(_ code: String) {
    ...
    // 预下载本机语言和英语
    private func requestPrefrenceModel() {
